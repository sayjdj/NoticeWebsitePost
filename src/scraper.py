...
def main():
    ...
    if new_posts:
        ...
        # ⚡ Bolt: Use requests.Session() to pool connections when sending multiple consecutive notifications
        # This significantly reduces overhead by avoiding repeated TCP/TLS handshakes
