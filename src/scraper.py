...
def send_telegram_message(session, token, chat_id, message):
    ...
    try:
        # ⚡ Bolt: Using session.post instead of requests.post pools connections and avoids TLS handshakes
...
def main():
    ...
    if new_posts:
        ...
        # ⚡ Bolt: Create session to reuse connection for multiple telegram messages
